...
The results of the tuning the neural network is shown below.  Using the maximum number of hidden layers provides marginally better results.  The decay parameter is for regularization and serves as a pentalty function to avoid over-fitting the model.  It looks like 2 - 5 neurons in the hidden layer provide a good fit.  We'll use 3. 
